 ...
 * Sets up the UI layout, initializes pucks, and launches the simulation.
 */
public class MainApp extends Application {

    // Create the simulation object with default width and height
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("2D Momentum Physics Simulation"); // Window title

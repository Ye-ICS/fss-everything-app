...
public class DietManager {
   ...
   // boolean isDietHealthy() {
    ...
    void newDiet() {
        //  create a new diet
        if (Workout.desiredPhysique == "Skinny" && GeneralInfo.getAverageBuild() || GeneralInfo.getBigBuild() || GeneralInfo.getFitBuild()) {
        ...
        } else if (Workout.desiredPhysique == "Lean" || Workout.desiredPhysique == "Bulk" && GeneralInfo.getSkinnyBuild() || GeneralInfo.getAverageBuild()) {
